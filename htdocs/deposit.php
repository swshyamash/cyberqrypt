          ...
          <?include 'includes/topheader.php';?>
            ...
            <div class="banner">
              <div class="container content">
                  <h1>Fiat Wallet</h1>
                  <p style="text-align: center;color: #fff;">Make a Deposit, view your wallet account balance and transactions.</p>
              </div>
          </div>
              <div class="Accounts__Container-cJqPrg TBfrq LayoutDesktop__Wrapper-ksSvka fWIqmZ Flex__Flex-fVJVYW cpsCBW">
                 <div class="LayoutDesktop__Content-flhQBc kuJaHF Flex__Flex-fVJVYW gkSoIH">
                  <div class="description-box" style="    border: 1px solid #DAE1E9;
    padding: 10px;margin: 0 0 1em;border-radius: 4px;">
                    <p>Here you can:</p>
                    <ol>
                      <li>Record the transaction details of the fiat currency deposits you made to this exchange. </li>
                  ...
                  <div class="Panel__Container-hCUKEb ejcVRF">
                    <div class="Accounts__Header-kUlsOz hjYHLC Flex__Flex-fVJVYW hQXxaf">
                      <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;">
                        <span>Your Fiat Currency Transactions
                        </span>
                        
                      </h4>
                      <span style="float:right">
                          <a href="javascript:void(0);" id="myBtn" class="gVLEBI" style="background: #f5ba30;border-color: #f5ba30;color: #fff !important;">Add Deposit</a>
                          <a href="bank-accounts.php" class="gVLEBI dummy ">Manage Bank accounts</a>
                                  ...
                                  <div class="AccountListItem__Details-cWizxw GENJj Flex__Flex-fVJVYW bHipRv">
                                    ...
                                    <div class="AccountListItem__Actions-bsqZNF fNrJZo Flex__Flex-fVJVYW iDqRrV">
                                      <div class="Flex__Flex-fVJVYW ghkoKS">
                                        <!-- <button onclick="location.href='userbuy?trade=BTC-USD'" class="myBtn AccountActionButtons__AccountButton-ejRNLb hOLrOE Button__Container-hQftQV gVLEBI dummy" id="deposite">
                                          <div class="Button__Content-eaBvLU iOGmBb Flex__Flex-fVJVYW iDqRrV">
                                            
                                            <span>Buy/Sell Crypto
                                            </span>
                                          </div>
                                        </button> -->
                                        <button style="border-color: #1265d1;color: #1265d1;" onclick="location.href='userbuy?trade=BTC-USD'" class="AccountActionButtons__AccountButton-ejRNLb hOLrOE Button__Container-hQftQV gVLEBI" id="withdraw">
                                          <div class="Button__Content-eaBvLU iOGmBb Flex__Flex-fVJVYW iDqRrV">
                                            <span>Buy/Sell Crypto
                                            </span>
                                          </div>
